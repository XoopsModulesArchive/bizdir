...
// $Id: main.php,v 1.1 2006/03/26 21:16:35 mikhail Exp $
//%%%%%%		Module Name 'bizdir'		%%%%%
...
define(
    '_MD_ATTENTION',
    '<strong>Attention Business Owners!</strong> Getting your business listed is easy and FREE! <br>Simply <a href="'
    . XOOPS_URL
    . '/register.php"><u>register with {X_SITENAME}</u></a> Once registration is completed <br>just logon and <a href="'
    . XOOPS_URL
    . '/modules/bizdir/submit.php"><u>submit your business</u></a>.'
);
...
define('_MD_CONTACT', 'Contact Person: ');
define('_MD_BUSADDRESS', 'Address: ');
define('_MD_BUSADDRESS2', 'Address2: ');
define('_MD_BUSCITY', 'City: ');
define('_MD_BUSSTATE', 'Province: ');
define('_MD_BUSZIP', 'Postal Code: ');
...
//%%%%%%	Module Name 'bizdir' (Admin)	  %%%%%

define('_MD_WEBLINKSCONF', 'Directory Listing Configuration');
define('_MD_GENERALSET', 'Business Directory General Settings');
...
define('_MD_GETMAP', 'Map');
define('_MD_EMAILCONTACT', 'Email');
