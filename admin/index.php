...
function bizdir()
{
    ...
    $result2 = $xoopsDB->query('select count(*) from ' . $xoopsDB->prefix('bizdir_mod') . '');
    ...
    $result3 = $xoopsDB->query('select count(*) from ' . $xoopsDB->prefix('bizdir_links') . ' where status=0');
...
function listNewLinks()
{
    ...
    $linkimg_array = XoopsLists::getImgListAsArray(XOOPS_ROOT_PATH . '/modules/bizdir/images/shots/');

    $result = $xoopsDB->query('select lid, cid, title, Contact, address, address2, city, state, zip, country, phone, fax, email, url, logourl, submitter from ' . $xoopsDB->prefix('bizdir_links') . ' where status=0 order by date DESC');
    ...
    if ($numrows > 0) {
        while (list($lid, $cid, $title, $Contact, $address, $address2, $city, $state, $zip, $country, $phone, $fax, $email, $url, $logourl, $submitterid) = $xoopsDB->fetchRow($result)) {
            ...
            echo '</td></tr><tr><td align="right" nowrap>' . _MD_CONTACT . '</td><td>';

            echo "<input type=\"text\" name=\"Contact\" size=\"50\" maxlength=\"200\" value=\"$Contact\">";

            echo '</td></tr><tr><td align="right" nowrap>' . _MD_BUSADDRESS . '</td><td>';

            echo "<input type=\"text\" name=\"address\" size=\"50\" maxlength=\"100\" value=\"$address\">";

            echo '</td></tr><tr><td align="right" nowrap>' . _MD_BUSADDRESS2 . '</td><td>';

            echo "<input type=\"text\" name=\"address2\" size=\"50\" maxlength=\"100\" value=\"$address2\">";

            echo '</td></tr><tr><td align="right" nowrap>' . _MD_BUSCITY . '</td><td>';

            echo "<input type=\"text\" name=\"city\" size=\"50\" maxlength=\"80\" value=\"$city\">";

            echo '</td></tr><tr><td align="right" nowrap>' . _MD_BUSSTATE . '</td><td>';

            echo "<input type=\"text\" name=\"state\" size=\"50\" maxlength=\"30\" value=\"$state\">";

            echo '</td></tr><tr><td align="right" nowrap>' . _MD_BUSZIP . '</td><td>';

            echo "<input type=\"text\" name=\"zip\" size=\"50\" maxlength=\"20\" value=\"$zip\">";
            ...
            echo "<input type=\"text\" name=\"phone\" size=\"50\" maxlength=\"35\" value=\"$phone\">";

            echo '</td></tr><tr><td align="right" nowrap>' . _MD_BUSFAX . '</td><td>';

            echo "<input type=\"text\" name=\"fax\" size=\"50\" maxlength=\"35\" value=\"$fax\">";

            echo '</td></tr><tr><td align="right" nowrap>' . _MD_BUSEMAIL . '</td><td>';

            echo "<input type=\"text\" name=\"email\" size=\"50\" maxlength=\"100\" value=\"$email\">";

            echo '</td></tr><tr><td align="right" nowrap>' . _MD_SITEURL . '</td><td>';

            echo "<input type=\"text\" name=\"url\" size=\"50\" maxlength=\"255\" value=\"$url\">";
            ...
            echo "<input type=\"text\" name=\"logourl\" size=\"50\" maxlength=\"255\">\n";
            ...
            $shotdir = '<b>' . XOOPS_URL . '/modules/bizdir/images/shots/</b>';
...
function linksConfigMenu()
{
    ...
    echo '' . _MD_IMGURL . '<br><input type="text" name="imgurl" size="100" maxlength="255" value="http://"><br><br>';
    ...
    $result = $xoopsDB->query('select count(*) from ' . $xoopsDB->prefix('bizdir_cat') . '');
    ...
    if ($numrows > 0) {
        ...
        #		echo "<br>"._MD_IMGURL."<br><input type=\"text\" name=\"imgurl\" size=\"100\" maxlength=\"255\">\n";
        ...
        echo '<tr><td align="right">' . _MD_CONTACT . '</td><td>';

        echo '<input type=text name=Contact size=50 maxlength=200>';
        ...
        echo '<input type=text name=city size=50 maxlength=80>';

        echo "</td></tr>\n";

        echo '<tr><td align="right">' . _MD_BUSSTATE . '</td><td>';

        echo '<input type=text name=state size=2 maxlength=30>';

        echo "</td></tr>\n";

        echo '<tr><td align="right">' . _MD_BUSZIP . '</td><td>';

        echo '<input type=text name=zip size=50 maxlength=20>';
        ...
        echo '<input type=text name=phone size=50 maxlength=35>';

        echo "</td></tr>\n";

        echo '<tr><td align="right">' . _MD_BUSFAX . '</td><td>';

        echo '<input type=text name=fax size=50 maxlength=35>';
        ...
        echo '<input type=text name=url size=50 maxlength=255 value="http://">';
    ...
    $result2 = $xoopsDB->query('select count(*) from ' . $xoopsDB->prefix('bizdir_links') . '');
    ...
    if ($numrows2 > 0) {
        ...
        echo "<input type=hidden name=fct value=bizdir>\n";
...
function modLink()
{
    ...
    $result = $xoopsDB->query('select cid, title, Contact, address, address2, city, state, zip, country, phone, fax, email, url, logourl from ' . $xoopsDB->prefix('bizdir_links') . " where lid=$lid") or $eh::show('0013');
    ...
    echo '<tr><td>' . _MD_CONTACT . "</td><td><input type=text name=Contact value=\"$Contact\" size=50 maxlength=200></td></tr>\n";
    ...
    echo '<tr><td>' . _MD_BUSCITY . "</td><td><input type=text name=city value=\"$city\" size=50 maxlength=80></td></tr>\n";

    echo '<tr><td>' . _MD_BUSSTATE . "</td><td><input type=text name=state value=\"$state\" size=2 maxlength=30></td></tr>\n";

    echo '<tr><td>' . _MD_BUSZIP . "</td><td><input type=text name=zip value=\"$zip\" size=50 maxlength=20></td></tr>\n";

    echo '<tr><td>' . _MD_BUSCOUNTRY . "</td><td><input type=text name=country value=\"$country\" size=50 maxlength=100></td></tr>\n";

    echo '<tr><td>' . _MD_BUSPHONE . "</td><td><input type=text name=phone value=\"$phone\" size=50 maxlength=35></td></tr>\n";

    echo '<tr><td>' . _MD_BUSFAX . "</td><td><input type=text name=fax value=\"$fax\" size=50 maxlength=35></td></tr>\n";

    echo '<tr><td>' . _MD_BUSEMAIL . "</td><td><input type=text name=email value=\"$email\" size=50 maxlength=100></td></tr>\n";

    echo '<tr><td>' . _MD_SITEURL . "</td><td><input type=text name=url value=\"$url\" size=50 maxlength=255></input></td></tr>\n";
    ...
    //echo "<input type=text name=logourl value=\"$logourl\" size=\"50\" maxlength=\"255\"></input>
    ...
    $result5 = $xoopsDB->query('SELECT count(*) FROM ' . $xoopsDB->prefix('bizdir_votedata') . " WHERE lid = $lid");
    ...
    $result5 = $xoopsDB->query('SELECT ratingid, ratinguser, rating, ratinghostname, ratingtimestamp FROM ' . $xoopsDB->prefix('bizdir_votedata') . " WHERE lid = $lid AND ratinguser >0 ORDER BY ratingtimestamp DESC");
    ...
    while (list($ratingid, $ratinguser, $rating, $ratinghostname, $ratingtimestamp) = $xoopsDB->fetchRow($result5)) {
        ...
        $result2 = $xoopsDB->query('SELECT rating FROM ' . $xoopsDB->prefix('bizdir_votedata') . " WHERE ratinguser = '$ratinguser'");
    ...
    $result5 = $xoopsDB->query('SELECT ratingid, rating, ratinghostname, ratingtimestamp FROM ' . $xoopsDB->prefix('bizdir_votedata') . " WHERE lid = $lid AND ratinguser = 0 ORDER BY ratingtimestamp DESC");
...
function delVote()
{
    ...
    $sql = sprintf('DELETE FROM %s WHERE ratingid = %u', $xoopsDB->prefix('bizdir_votedata'), $rid);
...
function listModReq()
{
    ...
    $result = $xoopsDB->query('select * from ' . $xoopsDB->prefix('bizdir_mod') . ' order by requestid');
    ...
    if ($totalmodrequests > 0) {
        ...
        while (list($requestid, $lid, $cid, $title, $Contact, $address, $address2, $city, $state, $zip, $country, $phone, $fax, $email, $url, $logourl, $description, $modifysubmitter) = $xoopsDB->fetchRow($result)) {
            $lookup_lid[$requestid] = $lid;

            $result2 = $xoopsDB->query('select cid, title, Contact, address, address2, city, state, zip, country, phone, fax, email, url, logourl, submitter from ' . $xoopsDB->prefix('bizdir_links') . " where lid=$lid");

            [$origcid, $origtitle, $origContact, $origaddress, $origaddress2, $origcity, $origstate, $origzip, $origcountry, $origphone, $origfax, $origemail, $origurl, $origlogourl, $ownerid] = $xoopsDB->fetchRow($result2);
			...
			<tr><td valign=top width=45%><small>" . _MD_CONTACT . "<br>$origContact</small></td></tr>
            ...
            if ($xoopsModuleConfig['useshots'] && !empty($origlogourl)) {
                echo '<img src="../images/shots/' . $origlogourl . '" width="' . $xoopsModuleConfig['shotwidth'] . '">';
            } else {
                echo ' ';
            }
			...
			<tr><td valign=top width=45%><small>" . _MD_CONTACT . "<br>$Contact</small></td></tr>
            ...
            if (1 == $xoopsModuleConfig['useshots'] && !empty($logourl)) {
                echo '<img src="../images/shots/' . $logourl . '" width="' . $xoopsModuleConfig['shotwidth'] . '" alt="/">';
            } else {
                echo ' ';
            }
...
function changeModReq()
{
    ...
    $query = 'select requestid, lid, cid, title, Contact, address, address2, city, state, zip, country, phone, fax, email, url, logourl, description from ' . $xoopsDB->prefix('bizdir_mod') . ' where requestid=' . $requestid . '';

    $result = $xoopsDB->query($query);

    while (list($requestid, $lid, $cid, $title, $Contact, $address, $address2, $city, $state, $zip, $country, $phone, $fax, $email, $url, $logourl, $description) = $xoopsDB->fetchRow($result)) {
        ...
        $sql = sprintf(
            "UPDATE %s SET cid = %u, title = '%s', Contact = '%s', address = '%s', address2 = '%s', city = '%s', state = '%s', zip = '%s', country = '%s', phone = '%s', fax = '%s', email = '%s', url = '%s', logourl = '%s', status = %u, date = %u WHERE lid = %u",
        ...
        $sql = sprintf("UPDATE %s SET description = '%s' WHERE lid = %u", $xoopsDB->prefix('bizdir_text'), $description, $lid);

        $xoopsDB->query($sql) or $eh::show('0013');

        $sql = sprintf('DELETE FROM %s WHERE requestid = %u', $xoopsDB->prefix('bizdir_mod'), $requestid);
...
function ignoreModReq()
{
    ...
    $sql = sprintf('DELETE FROM %s WHERE requestid = %u', $xoopsDB->prefix('bizdir_mod'), $_GET['requestid']);
...
function modLinkS()
{
    ...
    $Contact = $myts->addSlashes($_POST['Contact']);
    ...
    $xoopsDB->query(
        'update '
        . $xoopsDB->prefix('bizdir_links')
        . " set cid='$cid', title='$title', Contact='$Contact', address='$address', address2='$address2', city='$city', state='$state', zip='$zip', country='$country', phone='$phone', fax='$fax', email='$email', url='$url', logourl='$logourl', status=2, date="
        . time()
        . ' where lid='
        . $_POST['lid']
        . ''
    ...
    $xoopsDB->query('update ' . $xoopsDB->prefix('bizdir_text') . " set description='$description' where lid=" . $_POST['lid'] . '') or $eh::show('0013');
...
function delLink()
{
    ...
    $sql = sprintf('DELETE FROM %s WHERE lid = %u', $xoopsDB->prefix('bizdir_links'), $_GET['lid']);

    $xoopsDB->query($sql) or $eh::show('0013');

    $sql = sprintf('DELETE FROM %s WHERE lid = %u', $xoopsDB->prefix('bizdir_text'), $_GET['lid']);

    $xoopsDB->query($sql) or $eh::show('0013');

    $sql = sprintf('DELETE FROM %s WHERE lid = %u', $xoopsDB->prefix('bizdir_votedata'), $_GET['lid']);
...
function modCat()
{
    ...
    $result = $xoopsDB->query('select pid, title, imgurl from ' . $xoopsDB->prefix('bizdir_cat') . " where cid=$cid");
    ...
    echo '<form action=index.php method=post>' . _MD_TITLEC . "<input type=text name=title value=\"$title\" size=51 maxlength=50><br><br>" . _MD_IMGURLMAIN . "<br><input type=text name=imgurl value=\"$imgurl\" size=100 maxlength=255><br><br>";
...
function modCatS()
{
    ...
    $xoopsDB->query('update ' . $xoopsDB->prefix('bizdir_cat') . " set pid=$pid, title='$title', imgurl='$imgurl' where cid=$cid") or $eh::show('0013');
...
function delCat()
{
    ...
    if (1 == $ok) {
        ...
        for ($i = 0; $i < $dcount; $i++) {
            ...
            $result = $xoopsDB->query('select lid from ' . $xoopsDB->prefix('bizdir_links') . ' where cid=' . $arr[$i] . '') or $eh::show('0013');

            //now for each link, delete the text data and vote ata associated with the link

            while (list($lid) = $xoopsDB->fetchRow($result)) {
                $sql = sprintf('DELETE FROM %s WHERE lid = %u', $xoopsDB->prefix('bizdir_text'), $lid);

                $xoopsDB->query($sql) or $eh::show('0013');

                $sql = sprintf('DELETE FROM %s WHERE lid = %u', $xoopsDB->prefix('bizdir_votedata'), $lid);

                $xoopsDB->query($sql) or $eh::show('0013');

                $sql = sprintf('DELETE FROM %s WHERE lid = %u', $xoopsDB->prefix('bizdir_links'), $lid);
            ...
            $sql = sprintf('DELETE FROM %s WHERE cid = %u', $xoopsDB->prefix('bizdir_cat'), $arr[$i]);
        ...
        $result = $xoopsDB->query('select lid from ' . $xoopsDB->prefix('bizdir_links') . ' where cid=' . $cid . '') or $eh::show('0013');
        ...
        $sql = sprintf('DELETE FROM %s WHERE cid = %u', $xoopsDB->prefix('bizdir_cat'), $cid);
...
function addCat()
{
    ...
    $newid = $xoopsDB->genId($xoopsDB->prefix('bizdir_cat') . '_cid_seq');

    $sql = sprintf("INSERT INTO %s (cid, pid, title, imgurl) VALUES (%u, %u, '%s', '%s')", $xoopsDB->prefix('bizdir_cat'), $newid, $pid, $title, $imgurl);
...
function addLink()
{
    ...
    $result = $xoopsDB->query('select count(*) from ' . $xoopsDB->prefix('bizdir_links') . " where title='$title'");
    ...
    $sql = sprintf(
        "INSERT INTO %s (lid, cid, title, Contact, address, address2, city, state, zip, country, phone, fax, email, url, logourl, submitter, status, date, hits, rating, votes, comments) VALUES (%u, %u, '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', %u, %u, %u, %u, %u, %u, %u)",
        $xoopsDB->prefix('bizdir_links'),
        $newid,
        $cid,
        $title,
...
function approve()
{
    ...
    $query = 'update '
                   . $xoopsDB->prefix('bizdir_links')
                   . " set cid='$cid', title='$title', Contact='$Contact', address='$address', address2='$address2', city='$city', state='$state', zip='$zip', country='$country', phone='$phone', fax='$fax', email='$email', url='$url', logourl='$logourl', status=1, date="
                   . time()
                   . ' where lid='
                   . $lid
                   . '';
    ...
    $query = 'update ' . $xoopsDB->prefix('bizdir_text') . " set description='$description' where lid=" . $lid . '';
